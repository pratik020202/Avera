...
if(isset($_POST['submit'])){
    ...
    if($_FILES['image']['type']!='' && ($_FILES['image']['type']!='image/jpeg' || $_FILES['image']['type']!='image/png' || $_FILES['image']['type']!='image/jpg')){
        $msg="Please Select Only jpeg,png and jpg image format";
